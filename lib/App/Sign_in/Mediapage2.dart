...
//   Future<void> saveIMagesLocally(
//       File imgFile, String recId, String type, postUrl) async {
//     var noNetwork = NoNetworkService();
//     // noNetwork.storeFailedFileUploadRequest(imgFile, postUrl);
//     log("Save to local device");
//     var tempDir = await getTemporaryDirectory();
//     var x = await imgFile
//         .copy('${tempDir.path}/${DateTime.now().toIso8601String()}__$type.jpg');
//     await noNetwork.storeFailedFileUploadRequest(x.path, postUrl);
//   }
...
//     } catch (e) {
//       log(e.toString());
//       await saveIMagesLocally(file, widget.recordId, type, fileUploadUrl);
//     }
//   }
...
//   test() {
//     log(widget.fieldData.leaderImage);
//     log(widget.fieldData.familyImage);
//     log(widget.fieldData.gatheringImage);
//     log(widget.fieldData.communityImage);
//   }
...
//                 onTap: () => test(), child: Center(child: Text('Add Media'))),
//           ),
...
//                                             cacheKey:
//                                                 '${widget.fieldData.locationId}__leader}',
//                                             imageUrl:
//                                                 widget.fieldData.leaderImage,
...
//                                           )
//                                     : CachedNetworkImage(
//                                         imageUrl: widget.fieldData.familyImage,
//                                         cacheKey:
//                                             '${widget.fieldData.locationId}__family',
//                                         placeholder: (context, url) =>
//                                             CircularProgressIndicator(),
//                                         /*  loadingBuilder:
...
//                                             widget.fieldData.communityImage,
//                                         cacheKey:
//                                             '${widget.fieldData.locationId}__community',
//                                         placeholder: (context, url) =>
//                                             CircularProgressIndicator(),
//                                         /*  loadingBuilder:
...
//                                             widget.fieldData.gatheringImage,
//                                         cacheKey:
//                                             '${widget.fieldData.locationId}__gathering',
//                                         placeholder: (context, url) =>
//                                             CircularProgressIndicator(),
//                                         height: 100,
//                                         /*  loadingBuilder:
